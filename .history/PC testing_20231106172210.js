...
// Last modified: "2023/11/06 17:21:41"
...
defaultVal, minVal, maxVal, precision need number`);
    ...
    checkbox(name = 'p5js_ctrler_checkbox', defaultVal = false, labelText = ['yes', 'no'], fxn = () => { }) {
        ...
        const labelRetext = (label, newContext) => {
            ...
            } else { console.error('cant find text of checkbox content')}
        }
        this.ctrlers[name].elt.querySelector('label').textContent = labelText[this.ctrlers[name].checked() ? 0 : 1];
