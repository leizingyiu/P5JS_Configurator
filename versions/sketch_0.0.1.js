...
const sketch = p => {
  p.preload = function () {
    ...
    pc.load(preset);
    pc.container.elt.querySelector('[id*="header"] p').innerText = pc.container.elt.querySelector('[id*="header"] p').innerText + '_0.0.1';
    pc.container.elt.querySelector('[id*="header"]').style.color = '#fff';
  }
